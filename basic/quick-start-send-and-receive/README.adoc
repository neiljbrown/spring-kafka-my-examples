...
|Tag|Purpose
|0.0.1
|A fully functional example which illustrates how to create the necessary Spring for Kafka objects for sending & receiving messages using plan Java alone, without relying on Spring bean config (or Spring Boot.
|===
